...
namespace WinFormsApp1.Figures
{
    ...
    public class Figure
    {
        ...
        /// <summary>
        /// Removes all matches from indexator
        /// </summary>
        /// <param name="match">Mathes to remove</param>
        ...
        /// <summary>
        /// Serializes the specified Figure object to a binary file with the specified filename.
        /// </summary>
        /// <param name="fileName">The name of the binary file to create.</param>
        /// <param name="figure">The Figure object to serialize.</param>
        public static void SerializeBIN(string fileName, Figure? figure)
        {
        ...
        /// <summary>
        /// Deserializes a Figure object from a binary file with the specified filename.
        /// </summary>
        /// <param name="fileName">The name of the binary file to deserialize.</param>
        /// <returns>The deserialized Figure object, or null if deserialization failed.</returns>
        public static Figure? DeserializeBIN(string fileName)
        {
            ...
            return JsonConvert.DeserializeObject<Figure>(json, settings);
        }

        /// <summary>
        /// Serializes the specified Figure object to a text file with the specified filename.
        /// </summary>
        /// <param name="fileName">The name of the text file to create.</param>
        /// <param name="figure">The Figure object to serialize.</param>
        public static void SerializeTXT(string fileName, Figure? figure)
        {
            SerializeJSON(fileName, figure);
        }

        /// <summary>
        /// Deserializes a Figure object from a text file with the specified filename.
        /// </summary>
        /// <param name="fileName">The name of the text file to deserialize.</param>
        /// <returns>The deserialized Figure object, or null if deserialization failed.</returns>
        public static Figure? DeserializeTXT(string fileName)
        {
